...
interface ChatContentType {
    currentChat: { _id: string, members: string[], createdAt: Date, updatedAt: Date };
    messages: { _id: string, chatId: string, senderId: string, text: string, createdAt: Date, updatedAt: Date }[];
    isMessageLoading: boolean;
    sendTextMessage: (text: string, sender: { email: string, name: string, token: string, _id: string },currentChatId: string, setTexMessage: any) => void;
}
